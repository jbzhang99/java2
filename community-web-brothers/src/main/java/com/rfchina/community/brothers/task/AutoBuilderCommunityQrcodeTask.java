 ...
 */
//@Component
public class AutoBuilderCommunityQrcodeTask {
	...
	@Scheduled(initialDelay = 15000, fixedDelay = 15 * 60 * 1000L)
	public void builderCommunityQrcode() {
		logger.info("builderCommunityQrcode is run :{}", builderCommunityQrcode);
