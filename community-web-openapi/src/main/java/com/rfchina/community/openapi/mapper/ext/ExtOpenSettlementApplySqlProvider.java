...
public class ExtOpenSettlementApplySqlProvider {
	...
	public String pageByCondition(Map<String, Object> param){
		StringBuffer sb = new StringBuffer("select t.*,d.title as service_name from open_settlement_apply t join community_service d on t.service_id=d.id where 1=1 ");
