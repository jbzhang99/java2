package com.rfchina.community.openstore.util;
...
public class PlatformUtil {
	...
	protected static String getRemoteAccessToken(String rfpayHost ,Long appId, String appSecret) {
        ...
        logger.info("Invoke [getRemoteAccessToken] with parameters: {}, {}, and response: {}", appId, appSecret,JSON.toJSONString(responseData));
