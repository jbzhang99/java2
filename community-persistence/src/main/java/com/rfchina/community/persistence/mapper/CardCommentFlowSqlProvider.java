...
import com.rfchina.community.persistence.model.CardCommentFlowExample.Criteria;
import com.rfchina.community.persistence.model.CardCommentFlowExample.Criterion;
import com.rfchina.community.persistence.model.CardCommentFlowExample;
import java.util.List;
import java.util.Map;
import org.apache.ibatis.jdbc.SQL;

public class CardCommentFlowSqlProvider {

    public String countByExample(CardCommentFlowExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("card_comment_flow");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String deleteByExample(CardCommentFlowExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("card_comment_flow");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String insertSelective(CardCommentFlow record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("card_comment_flow");
        ...
        if (record.getReplyUid() != null) {
            sql.VALUES("reply_uid", "#{replyUid,jdbcType=BIGINT}");
        }
    ...
    public String selectByExample(CardCommentFlowExample example) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        CardCommentFlow record = (CardCommentFlow) parameter.get("record");
        CardCommentFlowExample example = (CardCommentFlowExample) parameter.get("example");
        
        SQL sql = new SQL();
        sql.UPDATE("card_comment_flow");
        ...
        if (record.getReplyUid() != null) {
            sql.SET("reply_uid = #{record.replyUid,jdbcType=BIGINT}");
        }
    ...
    public String updateByPrimaryKeySelective(CardCommentFlow record) {
        SQL sql = new SQL();
        sql.UPDATE("card_comment_flow");
        ...
        if (record.getReplyUid() != null) {
            sql.SET("reply_uid = #{replyUid,jdbcType=BIGINT}");
        }
    ...
    protected void applyWhere(SQL sql, CardCommentFlowExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
