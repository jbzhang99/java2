...
import com.rfchina.community.persistence.model.CommunityMsgExample.Criteria;
import com.rfchina.community.persistence.model.CommunityMsgExample.Criterion;
import com.rfchina.community.persistence.model.CommunityMsgExample;
import java.util.List;
import java.util.Map;
import org.apache.ibatis.jdbc.SQL;

public class CommunityMsgSqlProvider {

    public String countByExample(CommunityMsgExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("community_msg");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String deleteByExample(CommunityMsgExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("community_msg");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String insertSelective(CommunityMsg record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("community_msg");
    ...
    public String selectByExample(CommunityMsgExample example) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        CommunityMsg record = (CommunityMsg) parameter.get("record");
        CommunityMsgExample example = (CommunityMsgExample) parameter.get("example");
        
        SQL sql = new SQL();
        sql.UPDATE("community_msg");
    ...
    public String updateByPrimaryKeySelective(CommunityMsg record) {
        SQL sql = new SQL();
        sql.UPDATE("community_msg");
    ...
    protected void applyWhere(SQL sql, CommunityMsgExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
