...
import com.rfchina.community.persistence.model.CardLikeFlowExample.Criteria;
import com.rfchina.community.persistence.model.CardLikeFlowExample.Criterion;
import com.rfchina.community.persistence.model.CardLikeFlowExample;
import java.util.List;
import java.util.Map;
import org.apache.ibatis.jdbc.SQL;

public class CardLikeFlowSqlProvider {

    public String countByExample(CardLikeFlowExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("card_like_flow");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String deleteByExample(CardLikeFlowExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("card_like_flow");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String insertSelective(CardLikeFlow record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("card_like_flow");
    ...
    public String selectByExample(CardLikeFlowExample example) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        CardLikeFlow record = (CardLikeFlow) parameter.get("record");
        CardLikeFlowExample example = (CardLikeFlowExample) parameter.get("example");
        
        SQL sql = new SQL();
        sql.UPDATE("card_like_flow");
    ...
    public String updateByPrimaryKeySelective(CardLikeFlow record) {
        SQL sql = new SQL();
        sql.UPDATE("card_like_flow");
    ...
    protected void applyWhere(SQL sql, CardLikeFlowExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
