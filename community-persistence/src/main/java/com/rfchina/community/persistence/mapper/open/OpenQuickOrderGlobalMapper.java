...
public interface OpenQuickOrderGlobalMapper extends Serializable {
	...
	PageList<ExtOpenQuickOrder> pageByExample(Map<String, Object> example, PageBounds pageBounds);
