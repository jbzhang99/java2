...
import com.rfchina.community.persistence.model.CommunityServiceExample.Criteria;
import com.rfchina.community.persistence.model.CommunityServiceExample.Criterion;
import com.rfchina.community.persistence.model.CommunityServiceExample;
import java.util.List;
import java.util.Map;
import org.apache.ibatis.jdbc.SQL;

public class CommunityServiceSqlProvider {

    public String countByExample(CommunityServiceExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("community_service");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String deleteByExample(CommunityServiceExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("community_service");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String insertSelective(CommunityService record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("community_service");
    ...
    public String selectByExample(CommunityServiceExample example) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        CommunityService record = (CommunityService) parameter.get("record");
        CommunityServiceExample example = (CommunityServiceExample) parameter.get("example");
        
        SQL sql = new SQL();
        sql.UPDATE("community_service");
    ...
    public String updateByPrimaryKeySelective(CommunityService record) {
        SQL sql = new SQL();
        sql.UPDATE("community_service");
    ...
    protected void applyWhere(SQL sql, CommunityServiceExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
