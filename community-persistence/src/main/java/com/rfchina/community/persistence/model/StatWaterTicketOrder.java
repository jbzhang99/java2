...
public class StatWaterTicketOrder implements Serializable {
    private Long id;
    ...
    public boolean equals(Object that) {
        ...
        StatWaterTicketOrder other = (StatWaterTicketOrder) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getTicketCount() == null ? other.getTicketCount() == null : this.getTicketCount().equals(other.getTicketCount()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getTicketCount() == null) ? 0 : getTicketCount().hashCode());
