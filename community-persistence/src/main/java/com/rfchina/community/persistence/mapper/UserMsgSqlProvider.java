...
import com.rfchina.community.persistence.model.UserMsgExample.Criteria;
import com.rfchina.community.persistence.model.UserMsgExample.Criterion;
...
public class UserMsgSqlProvider {
    ...
    public String countByExample(UserMsgExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("user_msg");
    ...
    public String insertSelective(UserMsg record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("user_msg");
        
        if (record.getToUid() != null) {
            sql.VALUES("to_uid", "#{toUid,jdbcType=BIGINT}");
        }
    ...
    public String selectByExampleWithBLOBs(UserMsgExample example) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getToUid() != null) {
            sql.SET("to_uid = #{record.toUid,jdbcType=BIGINT}");
        }
    ...
    public String updateByPrimaryKeySelective(UserMsg record) {
        ...
        if (record.getToUid() != null) {
            sql.SET("to_uid = #{toUid,jdbcType=BIGINT}");
        }
