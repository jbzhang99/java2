...
import com.rfchina.community.persistence.model.CommunityServiceRelaTempExample.Criteria;
import com.rfchina.community.persistence.model.CommunityServiceRelaTempExample.Criterion;
import com.rfchina.community.persistence.model.CommunityServiceRelaTempExample;
import java.util.List;
import java.util.Map;
import org.apache.ibatis.jdbc.SQL;

public class CommunityServiceRelaTempSqlProvider {

    public String countByExample(CommunityServiceRelaTempExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("community_service_rela_temp");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String deleteByExample(CommunityServiceRelaTempExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("community_service_rela_temp");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String insertSelective(CommunityServiceRelaTemp record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("community_service_rela_temp");
    ...
    public String selectByExampleWithBLOBs(CommunityServiceRelaTempExample example) {
        SQL sql = new SQL();
        ...
        sql.FROM("community_service_rela_temp");
        applyWhere(sql, example, false);
    ...
    public String selectByExample(CommunityServiceRelaTempExample example) {
        SQL sql = new SQL();
        if (example != null && example.isDistinct()) {
            sql.SELECT_DISTINCT("community_id");
        } else {
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        CommunityServiceRelaTemp record = (CommunityServiceRelaTemp) parameter.get("record");
        CommunityServiceRelaTempExample example = (CommunityServiceRelaTempExample) parameter.get("example");
        
        SQL sql = new SQL();
        sql.UPDATE("community_service_rela_temp");
    ...
    public String updateByPrimaryKeySelective(CommunityServiceRelaTemp record) {
        SQL sql = new SQL();
        sql.UPDATE("community_service_rela_temp");
    ...
    protected void applyWhere(SQL sql, CommunityServiceRelaTempExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
