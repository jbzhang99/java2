...
import com.rfchina.community.persistence.model.QrcodeDownloadLogExample.Criteria;
import com.rfchina.community.persistence.model.QrcodeDownloadLogExample.Criterion;
import com.rfchina.community.persistence.model.QrcodeDownloadLogExample;
import java.util.List;
import java.util.Map;
import org.apache.ibatis.jdbc.SQL;

public class QrcodeDownloadLogSqlProvider {

    public String countByExample(QrcodeDownloadLogExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("qrcode_download_log");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String deleteByExample(QrcodeDownloadLogExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("qrcode_download_log");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String insertSelective(QrcodeDownloadLog record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("qrcode_download_log");
        ...
        if (record.getTargetUrl() != null) {
            sql.VALUES("target_url", "#{targetUrl,jdbcType=LONGVARCHAR}");
        }
        
        return sql.toString();
    }

    public String selectByExampleWithBLOBs(QrcodeDownloadLogExample example) {
        SQL sql = new SQL();
    ...
    public String selectByExample(QrcodeDownloadLogExample example) {
        SQL sql = new SQL();
        if (example != null && example.isDistinct()) {
            sql.SELECT_DISTINCT("id");
        } else {
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        QrcodeDownloadLog record = (QrcodeDownloadLog) parameter.get("record");
        QrcodeDownloadLogExample example = (QrcodeDownloadLogExample) parameter.get("example");
        
        SQL sql = new SQL();
        sql.UPDATE("qrcode_download_log");
        ...
        if (record.getTargetUrl() != null) {
            sql.SET("target_url = #{record.targetUrl,jdbcType=LONGVARCHAR}");
        }
    ...
    public String updateByPrimaryKeySelective(QrcodeDownloadLog record) {
        SQL sql = new SQL();
        sql.UPDATE("qrcode_download_log");
        ...
        if (record.getTargetUrl() != null) {
            sql.SET("target_url = #{targetUrl,jdbcType=LONGVARCHAR}");
        }
    ...
    protected void applyWhere(SQL sql, QrcodeDownloadLogExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
