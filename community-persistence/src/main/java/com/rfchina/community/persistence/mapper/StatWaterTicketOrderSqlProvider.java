...
import com.rfchina.community.persistence.model.StatWaterTicketOrderExample.Criteria;
import com.rfchina.community.persistence.model.StatWaterTicketOrderExample.Criterion;
import com.rfchina.community.persistence.model.StatWaterTicketOrderExample;
import java.util.List;
import java.util.Map;
import org.apache.ibatis.jdbc.SQL;

public class StatWaterTicketOrderSqlProvider {

    public String countByExample(StatWaterTicketOrderExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("stat_water_ticket_order");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String deleteByExample(StatWaterTicketOrderExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("stat_water_ticket_order");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String insertSelective(StatWaterTicketOrder record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("stat_water_ticket_order");
        ...
        if (record.getTicketCount() != null) {
            sql.VALUES("ticket_count", "#{ticketCount,jdbcType=INTEGER}");
        }
        
        if (record.getFeeCount() != null) {
            sql.VALUES("fee_count", "#{feeCount,jdbcType=VARCHAR}");
        }
    ...
    public String selectByExample(StatWaterTicketOrderExample example) {
        SQL sql = new SQL();
        ...
        sql.SELECT("ticket_count");
        sql.SELECT("fee_count");
        sql.SELECT("stat_time");
        sql.SELECT("create_time");
        sql.FROM("stat_water_ticket_order");
        applyWhere(sql, example, false);
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        StatWaterTicketOrder record = (StatWaterTicketOrder) parameter.get("record");
        StatWaterTicketOrderExample example = (StatWaterTicketOrderExample) parameter.get("example");
        
        SQL sql = new SQL();
        sql.UPDATE("stat_water_ticket_order");
        ...
        if (record.getTicketCount() != null) {
            sql.SET("ticket_count = #{record.ticketCount,jdbcType=INTEGER}");
        }
        
        if (record.getFeeCount() != null) {
            sql.SET("fee_count = #{record.feeCount,jdbcType=VARCHAR}");
        }
    ...
    public String updateByPrimaryKeySelective(StatWaterTicketOrder record) {
        SQL sql = new SQL();
        sql.UPDATE("stat_water_ticket_order");
        ...
        if (record.getTicketCount() != null) {
            sql.SET("ticket_count = #{ticketCount,jdbcType=INTEGER}");
        }
        
        if (record.getFeeCount() != null) {
            sql.SET("fee_count = #{feeCount,jdbcType=VARCHAR}");
        }
    ...
    protected void applyWhere(SQL sql, StatWaterTicketOrderExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
