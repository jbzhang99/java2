...
import com.rfchina.community.persistence.model.OpenThirdAppTempExample.Criteria;
import com.rfchina.community.persistence.model.OpenThirdAppTempExample.Criterion;
import com.rfchina.community.persistence.model.OpenThirdAppTempExample;
import java.util.List;
import java.util.Map;
import org.apache.ibatis.jdbc.SQL;

public class OpenThirdAppTempSqlProvider {

    public String countByExample(OpenThirdAppTempExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("open_third_app_temp");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String deleteByExample(OpenThirdAppTempExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("open_third_app_temp");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String insertSelective(OpenThirdAppTemp record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("open_third_app_temp");
    ...
    public String selectByExample(OpenThirdAppTempExample example) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        OpenThirdAppTemp record = (OpenThirdAppTemp) parameter.get("record");
        OpenThirdAppTempExample example = (OpenThirdAppTempExample) parameter.get("example");
        
        SQL sql = new SQL();
        sql.UPDATE("open_third_app_temp");
    ...
    public String updateByPrimaryKeySelective(OpenThirdAppTemp record) {
        SQL sql = new SQL();
        sql.UPDATE("open_third_app_temp");
    ...
    protected void applyWhere(SQL sql, OpenThirdAppTempExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
