...
public class StatWaterOrder implements Serializable {
    private Long id;
    ...
    public boolean equals(Object that) {
        ...
        StatWaterOrder other = (StatWaterOrder) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getBucketCount() == null ? other.getBucketCount() == null : this.getBucketCount().equals(other.getBucketCount()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getBucketCount() == null) ? 0 : getBucketCount().hashCode());
