...
import com.rfchina.community.persistence.model.StatWaterOrderExample.Criteria;
import com.rfchina.community.persistence.model.StatWaterOrderExample.Criterion;
import com.rfchina.community.persistence.model.StatWaterOrderExample;
import java.util.List;
import java.util.Map;
import org.apache.ibatis.jdbc.SQL;

public class StatWaterOrderSqlProvider {

    public String countByExample(StatWaterOrderExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("stat_water_order");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String deleteByExample(StatWaterOrderExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("stat_water_order");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String insertSelective(StatWaterOrder record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("stat_water_order");
        ...
        if (record.getBucketCount() != null) {
            sql.VALUES("bucket_count", "#{bucketCount,jdbcType=INTEGER}");
        }
    ...
    public String selectByExample(StatWaterOrderExample example) {
        SQL sql = new SQL();
        ...
        sql.SELECT("bucket_count");
        sql.SELECT("stat_time");
        sql.SELECT("create_time");
        sql.FROM("stat_water_order");
        applyWhere(sql, example, false);
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        StatWaterOrder record = (StatWaterOrder) parameter.get("record");
        StatWaterOrderExample example = (StatWaterOrderExample) parameter.get("example");
        
        SQL sql = new SQL();
        sql.UPDATE("stat_water_order");
        ...
        if (record.getBucketCount() != null) {
            sql.SET("bucket_count = #{record.bucketCount,jdbcType=INTEGER}");
        }
    ...
    public String updateByPrimaryKeySelective(StatWaterOrder record) {
        SQL sql = new SQL();
        sql.UPDATE("stat_water_order");
        ...
        if (record.getBucketCount() != null) {
            sql.SET("bucket_count = #{bucketCount,jdbcType=INTEGER}");
        }
    ...
    protected void applyWhere(SQL sql, StatWaterOrderExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
