...
import com.rfchina.community.persistence.model.PropAddrUnbindExample.Criteria;
import com.rfchina.community.persistence.model.PropAddrUnbindExample.Criterion;
import com.rfchina.community.persistence.model.PropAddrUnbindExample;
import java.util.List;
import java.util.Map;
import org.apache.ibatis.jdbc.SQL;

public class PropAddrUnbindSqlProvider {

    public String countByExample(PropAddrUnbindExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("prop_addr_unbind");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String deleteByExample(PropAddrUnbindExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("prop_addr_unbind");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String insertSelective(PropAddrUnbind record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("prop_addr_unbind");
        
        if (record.getRefId() != null) {
            sql.VALUES("ref_id", "#{refId,jdbcType=BIGINT}");
        }
        ...
        if (record.getUnbindTime() != null) {
            sql.VALUES("unbind_time", "#{unbindTime,jdbcType=TIMESTAMP}");
        }
    ...
    public String selectByExample(PropAddrUnbindExample example) {
        SQL sql = new SQL();
        ...
        sql.SELECT("unbind_time");
        sql.SELECT("create_time");
        sql.SELECT("update_time");
        sql.FROM("prop_addr_unbind");
        applyWhere(sql, example, false);
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        PropAddrUnbind record = (PropAddrUnbind) parameter.get("record");
        PropAddrUnbindExample example = (PropAddrUnbindExample) parameter.get("example");
        
        SQL sql = new SQL();
        sql.UPDATE("prop_addr_unbind");
        ...
        if (record.getRefId() != null) {
            sql.SET("ref_id = #{record.refId,jdbcType=BIGINT}");
        }
        ...
        if (record.getUnbindTime() != null) {
            sql.SET("unbind_time = #{record.unbindTime,jdbcType=TIMESTAMP}");
        }
    ...
    public String updateByPrimaryKeySelective(PropAddrUnbind record) {
        SQL sql = new SQL();
        sql.UPDATE("prop_addr_unbind");
        
        if (record.getRefId() != null) {
            sql.SET("ref_id = #{refId,jdbcType=BIGINT}");
        }
        ...
        if (record.getUnbindTime() != null) {
            sql.SET("unbind_time = #{unbindTime,jdbcType=TIMESTAMP}");
        }
    ...
    protected void applyWhere(SQL sql, PropAddrUnbindExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
