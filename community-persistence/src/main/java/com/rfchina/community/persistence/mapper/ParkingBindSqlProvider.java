...
import com.rfchina.community.persistence.model.ParkingBindExample.Criteria;
import com.rfchina.community.persistence.model.ParkingBindExample.Criterion;
import com.rfchina.community.persistence.model.ParkingBindExample;
import java.util.List;
import java.util.Map;
import org.apache.ibatis.jdbc.SQL;

public class ParkingBindSqlProvider {

    public String countByExample(ParkingBindExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("parking_bind");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String deleteByExample(ParkingBindExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("parking_bind");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String insertSelective(ParkingBind record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("parking_bind");
    ...
    public String selectByExample(ParkingBindExample example) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ParkingBind record = (ParkingBind) parameter.get("record");
        ParkingBindExample example = (ParkingBindExample) parameter.get("example");
        
        SQL sql = new SQL();
        sql.UPDATE("parking_bind");
    ...
    public String updateByPrimaryKeySelective(ParkingBind record) {
        SQL sql = new SQL();
        sql.UPDATE("parking_bind");
    ...
    protected void applyWhere(SQL sql, ParkingBindExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
